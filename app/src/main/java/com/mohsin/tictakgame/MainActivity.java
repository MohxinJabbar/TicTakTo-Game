    ...
    public void check(View view) {
        ...
        if (currentButton.getText().toString().equals("")) {
            ...
            if (count > 4) {
                ...
                //condition to check all three  are same in sequence..
                if (b1.equals(b2) && b2.equals(b3) && !b1.equals("")) {
                    Toast.makeText(this, "Winner is " + b1, Toast.LENGTH_SHORT).show(); // it will generate the message of win if values are same.
                    restart();
